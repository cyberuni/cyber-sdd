...
Background survey distilling a working note on how "governance" relates to principle / policy / standard / guideline / procedure / discipline / framework, and where the repo's `*-governance` skills actually sit. **This repo's decisions already settle the question** — see [ADR-0001: Governance vs Discipline Taxonomy](https://github.com/cyberuni/cyberplace/blob/main/artifacts/adr/0001-governance-vs-discipline-taxonomy.md), [ADR-0013: Governance Skills](../../docs/adr/0013-governance-skills.md), [ADR-0014: Split SDD lifecycle into named governance skills](../../docs/adr/0014-sdd-governance-split.md), and [ADR-0006: "Agent Extension" as cross-layer term](https://github.com/cyberuni/cyberplace/blob/main/artifacts/adr/0006-agent-extension-terminology.md). This note is **evidence, not a normative rule** — it does not reopen those decisions.
