...
- 3f824e5: The plugin manifests carry the package version. They said `0.0.0` since the plugin was scaffolded, so `plugin update` could not tell a newer release apart.
